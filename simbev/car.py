        ...
        if self.car_type.output:
            ...
            if activity.at[activity.index[0], "event_start"] < 0:
                ...
                if activity.at[activity.index[0], "energy"] > 0:
                    ...
                    activity.at[activity.index[0], "energy"] = np.float32(new_demand)
                ...
                # change driving events
                    ...
                    activity.at[activity.index[0], "energy"] = np.float32(new_consumption)
                ...
                activity.at[activity.index[0], "average_charging_power"] = np.float32(activity.at[
